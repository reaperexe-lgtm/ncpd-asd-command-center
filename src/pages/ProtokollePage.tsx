                      ...
                      {m.gang_info && (
                        <div className="inline-flex items-stretch rounded-lg overflow-hidden border-2 border-purple-500/40">
                          ...
                          <div className="px-4 py-2 bg-purple-500/10">
                            <p className="text-[10px] uppercase tracking-wider text-purple-400 font-bold">Bande</p>
                            <p className="text-base font-bold text-purple-300 flex items-center gap-2"><Siren className="w-4 h-4" />{m.gang_info}</p>
                          </div>
                        </div>
                      )}
